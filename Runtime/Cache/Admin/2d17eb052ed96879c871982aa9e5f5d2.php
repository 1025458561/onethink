...
<body>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <tbody>
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$baoxiu): $mod = ($i % 2 );++$i;?><tr>
                        <td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo ($baoxiu['id']); ?>"> </td>
                        <td><?php echo ($baoxiu["id"]); ?></td>
                        ...
                        <td>
                            ...
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$baoxiu['id']);?>">删除</a>
                        </td>
