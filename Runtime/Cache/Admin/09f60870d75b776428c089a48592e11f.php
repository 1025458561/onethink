...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">详细内容<span class="check-tips">（必须填写）</span></label>
            <div class="controls">
               <textarea class="textarea" cols="50" rows="20" name="content" value="<?php echo ((isset($info["content"]) && ($info["content"] !== ""))?($info["content"]):''); ?>"></textarea>
            </div>
        </div>
