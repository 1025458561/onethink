...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">你的名字<span class="check-tips">（用于显示的文字）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="name" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">电话号码<span class="check-tips">（请填联系方式）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="tel" value="<?php echo ((isset($info["tel"]) && ($info["tel"] !== ""))?($info["tel"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">报修房号<span class="check-tips">（请填写正确地址以便联系）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="housenu" value="<?php echo ((isset($info["housenu"]) && ($info["housenu"] !== ""))?($info["housenu"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">身份证号码<span class="check-tips">（必须填写）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="idnu" value="<?php echo ((isset($info["idnu"]) && ($info["idnu"] !== ""))?($info["idnu"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">你的性别<span class="check-tips">（女士优先）</span></label>
            <div class="controls">
                <div class="controls">
